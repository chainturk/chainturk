# USAGE: Start chainturk-service as you usually would
...
from chainturk import Walletd as Wallet
import time
import argparse
parser = argparse.ArgumentParser()
parser.add_argument("--address", help="Chainturk address to optimize", required=True)
