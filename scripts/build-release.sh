...
function usage()
{
    ...
    echo "and generates the checksum files of the ChainTurk tag provided."
    echo
...
# -- Config
GITHUB_REPO="https://github.com/chainturk/chainturk.git"
CLONE_DIR="$BUILD_DIRECTORY/chainturk-buildall"
TARGET_DIR="$BUILD_DIRECTORY/chainturk-releases"
DYNAMIC_RELEASE="chainturk-${TAG_VERSION}-linux-CLI"
STATIC_RELEASE="chainturk-${TAG_VERSION}-linux-staticboost-CLI"
