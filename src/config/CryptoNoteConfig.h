...
const uint64_t MONEY_SUPPLY                                  = UINT64_C(8200000000);
...
/* This is the unix timestamp of the first "mined" block (technically block 2, not the genesis block)
   You can get this value by doing "print_block 2" in ChainTurkd. It is used to know what timestamp
...
const char     CRYPTONOTE_NAME[]                             = "ChainTurk";
